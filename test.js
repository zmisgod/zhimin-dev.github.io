...
// ----cur-2---
let a = new metroData({ x: 50, y: 50 },{ x: 200, y: 100 },  2);
let b = new metroData({ x: 200, y: 100 }, { x: 50, y: 50 }, 2);
let c = new metroData({ x: 50, y: 50 },{ x: 100, y: 200 },  2);
let d = new metroData({ x: 100, y: 200 }, { x: 50, y: 50 }, 2);
// ----cur-2---
